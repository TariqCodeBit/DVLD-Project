...
namespace DVLD_Fill_project.Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("There are no driver with ID = " + _DriverID.ToString(), "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("There are no driver linked with Person ID = " + PersonID.ToString(), "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

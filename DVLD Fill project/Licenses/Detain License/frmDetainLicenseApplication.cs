...
namespace DVLD_Fill_project.Licenses.Detain_License
{
    public partial class frmDetainLicenseApplication : Form
    {
        ...
        private void btnDetain_Click(object sender, EventArgs e)
        {
            ...
            _DetainID = ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.Detain(Convert.ToSingle(txtFineFees.Text), ClsGlobal.CurintUserinfo.UserID);
            if (_DetainID == -1)
            {
        ...
        private void txtFineFees_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (!ClsValdtion.ISNumber(txtFineFees.Text))
            {
                e.Cancel = true;

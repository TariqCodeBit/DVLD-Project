...
namespace DVLD_Fill_project.Testes.Controls
{
    public partial class crlScheduleTest : UserControl
    {
        ...
        public enum enCreationMode{FirstTimeSchedul,RetakeTestSchedule};
        public enCreationMode _CreationMode = enCreationMode.FirstTimeSchedul;
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID, int AppointmentID = -1)
        {
            ...
            if (_LocalDrivingLicenseApplication.DoesAttendTestType(_TestTypeID))
                ...
                _CreationMode = enCreationMode.FirstTimeSchedul;
        ...
        private bool _HandleRetakeApplication()
        {
            ...
            if (_Mode == enMode.AddNew && _CreationMode == enCreationMode.RetakeTestSchedule)
            {
                ...
                Application.CreatedByUserID = ClsGlobal.CurintUserinfo.UserID;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            _TestAppointment.CreatedByUserID = ClsGlobal.CurintUserinfo.UserID;
